            ...
            >
                <Observer>
                    <>
                        ...
                        <p className="text-[18px] leading-[161%] text-[rgba(255,255,255,0.7)] max-w-[450px] md:max-w-[300px]">{t("SeasonedFrontend")}</p>
                        <SecondaryButton text={t("MyContacts")} className="w-[255px] mt-[38px] md:mt-[29px]" />
                    </>
                </Observer>
            </div>
