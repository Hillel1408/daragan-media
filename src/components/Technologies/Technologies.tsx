...
export default function Technologies({ text, list }: { text: string; list: { text: string; icon: string; width: string; height: string }[] }) {
    ...
    return (
        <div className="border border-[#2b2b2d] rounded-[37px] py-[43px] px-[35px] bg-[rgba(35,38,57,0.1)] md:py-[23px] sm:-mx-[20px] sm:rounded-none sm:border-l-0 sm:border-r-0 sm:px-5 sm:gap-5">
            ...
            <ul className="text-[13px] leading-[223%] text-white flex gap-[32px] justify-center flex-wrap">
                {list.map((item, index) => (
