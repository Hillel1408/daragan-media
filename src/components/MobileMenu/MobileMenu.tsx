    ...
    return (
        <div
            className={classNames(
                "absolute px-4 pb-[28px] pt-[13px] border duration-200 border-[#2b2b2d] rounded-[8px] right-0 top-0 bg-[#131316] z-10 w-[156px] flex flex-col translate-x-[14px] translate-y-[-10px] sm:translate-x-0 sm:translate-y-0 sm:w-full sm:top-[72px] sm:rounded-none sm:border-none sm:h-[calc(100vh-72px)] sm:bg-[#111112]",
        ...
        >
            ...
            <div className="sm:bg-[#131316] sm:py-5">
