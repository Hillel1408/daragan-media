export default function Project({ item }: { item: { img: string; title: string; text: string; imgHover: string; href: string } }) {
    return (
        <div className="group relative">
            ...
            <a href={item.href} className="absolute top-0 bottom-0 left-0 right-0" target="_blank"></a>
        </div>
    );
}
